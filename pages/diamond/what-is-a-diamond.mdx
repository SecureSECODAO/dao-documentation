...
Proxies are a way to separate the data and logic of a contract. In classical software it can be compared to MVC (model-view-controller). Essentially, the logic, which consists of the functions that provide all of the functionality, can be replaced while preserving the data.
