...
The total cost is calculated as the hash cost times the amount of hashes in the project.

For an overview of SECOIN, please have a look at the [SECOIN page](/secoin).
