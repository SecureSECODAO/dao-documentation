...
Navigate to the [Query page](https://dao.secureseco.org/query) and fill in the fields.
...
For an overview of SECOIN, what it is, and how you can swap it for other monetary tokens, have a look at the [SECOIN page](/secoin).
...
- **Software Maintenance**: Information about the software evolution, such as changes
