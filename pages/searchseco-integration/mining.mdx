...
The Crawler uses the Github API to traverse the list of Github repositories. It
extracts metadata about the projects, such as who created the repo, the project's license, and more.
...
<Callout type="info" emoji="ⓘ">
  ...
  interact with the repositories you wish to mine.
</Callout>

<Steps>### Steps to running node here</Steps>
