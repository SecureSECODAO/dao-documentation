...
<Callout type="info" emoji="ⓘ">
  ...
  [contributing guidelines](/contributing#contribution-guidelines) first.
</Callout>

## Projet-Wide Ideas

These are some general ideas that would likely involve adjustments to multiple modules of the project, or are not specific to a specific module.
