...
Aragon recently introduced [AragonOSx](https://aragon.org/aragonosx), the smart contract foundation for their platform. The development of Aragon OSx's initial version is done and audited trice, Aragon's team recommends new DAOs to be built on this foundation because of its robust and future-proof design, instead of using their old AragonOS4.
