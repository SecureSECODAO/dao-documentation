...
Proposals are used to govern the DAO.
Proposals can be created and voted on by any member in the DAO. 
...
These actions can be executed if the proposal has reaced the required approval threshold.

The following steps explain how you can create your own proposal.
It costs a small amount of SECOREP and MATIC to create a proposal.

<Callout type="info" emoji="!">
  Before you can create a proposal, you need to [join the DAO](/joining) and ensure you have [earned enough SECOREP](secorep/earning).
</Callout>

<Steps>
### Start proposal creation

Go to the [governance page](https://dao.secureseco.org/governance) and click on the 'New proposal' button.
...
4. Add proposal resources. It is good practice to always add a place for dicussion for your proposal, e.g. a discord link.
...
<Callout type="info" emoji="!">
  There is a minimum duration for proposals. To account for time differences between time of creation and time of receival, a small time buffer might automatically be added to your duration.
</Callout>
