...
<Image
  ...
  quality={100}
  priority={true}
  alt="SecureSECO DAO documentation introduction image"
/>
...
The main purpose of the DAO is to incentivize contributions to SecureSECO in a sustainable manner. To this extent, it will also manage the treasury, and handle the governance of the organization.

Security should be a public good, and we believe that a DAO is the best way to achieve this.
...
Now, you're all set to dive deeper into the DAO. Interested in making a proposal or understanding how the proposal system works? Navigate to our [proposals section](/proposals).
Are you ready to make a query to SearchSECO? Head to our [SearchSECO guide](/searchseco-integration) to understand how to effectively interact with our distributed ledger system.
