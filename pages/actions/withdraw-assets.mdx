...
1. Enter the amount of the token for the amount field. Note that this field supports decimals. For example, it is possible to withdraw `0.0000000000001` MATIC.
...
1. The token decimals field should automatically be filled based on the token address.
   If this is not the case, this often means that the token address is incorrect! If you are sure the token address is correct, you can provide the token decimals manually.
...
1. Enter the token ID of the NFT to withdraw.
